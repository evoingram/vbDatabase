...
Public Sub pfFindRepCitationLinksOLD()
    '============================================================================
    ' Name        : pfFindRepCitationLinksOLD
    ' Author      : Erica L Ingram
    ' Copyright   : 2019, A Quo Co.
    ' Call command: Call pfFindRepCitationLinksOLD
    ' Description : OBSOLETE find and link citation markings like phonetic in transcript
    '============================================================================
...
Public Sub pfTopOfTranscriptBookmark()
    ...
    MsgBox ("(1).  Move all bookmarks to their corresponding headings; General, Witnesses, or Exhibits; (2), create the Authorities bookmark structure; (3) sort the Authorities bookmarks, then (4) hit okay.")
