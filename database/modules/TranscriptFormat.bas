...
Private sFileName As String
Private oWordApp As New Word.Application, oWordDoc As New Word.Document
Private qdf As QueryDef
Private sQueryName As String
Private db As Database
Public sBookmarkName As String
...
'============================================================================
Dim rstTRCourtQ As DAO.Recordset, rstViewJFAppQ As DAO.Recordset
Dim sFileName As String, sMrMs2 As String, sLastName2 As String, vSpeakerName As String
Dim oWordApp As New Word.Application, oCourtCoverWD As New Word.Document
Dim qdf As QueryDef
...
Dim oWordApp As New Word.Application, oWordDoc As New Word.Document
Dim sFileName As String, ReplaceWithName As String, FindFDA1 As String, FindFDA3 As String, QueryName As String
Dim FindFDA2 As String, FindFDA4 As String
...
Dim sFileName As String, sMrMs As String, sLastName As String, vSpeakerName As String
Dim oWordApp As New Word.Application, oWordDoc As New Word.Document
Dim qdf As QueryDef
...
Dim oCourtCoverWD As New Word.Document, oWordApp As New Word.Application
...
'for each result from Word doc query
    ...
    Dim rCurrentCitation As Range, sCurrentCitation As String
    Dim sCitationList() As String, sHyperlinkList() As String
...
Done:
    sCourtDatesID = Forms![NewMainMenu]![ProcessJobSubformNMM].Form![JobNumberField] 'job number come back
    sFileName = "I:\" & sCourtDatesID & "\Generated\" & sCourtDatesID & "-CourtCover.docx"
