...
Public Sub pfIEPostStringRequest(sURL As String, sFormData As String, sBoundary As String)
    ...
    Dim sResponseIDNumber As String
    Dim sResponseURL As String
    Dim sDestinationURL As String
    Dim sCorpusPath As String
    Dim sDownloadID As String
    Dim sDIC As String
    Dim sLM As String
    Dim sOnlineDIC As String
    Dim sOnlineLM As String
...
Public Sub pfDoFolder(Folder As Variant)
    ...
    Dim oSubfolder As Object
    Dim oWordApp As New Word.Application
    Dim oTranscriptionWD As New Word.Document
    Dim sCorpusPath As String
    Dim sDICPath As String
    Dim sLMPath As String
    Dim sDestinationURL As String
    Dim sFieldName As String
