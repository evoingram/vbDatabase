...
Else
    ...
    Call pfAcrobatGetNumPages(sCourtDatesID) 'GETS OFFICIAL PAGE COUNT AND UPDATES ACTUALQUANTITY
     ...
     Set qdf1 = CurrentDb.QueryDefs("TR-Court-Union-AppAddr")
...
Else
    ...
    ElseIf sJurisdiction = "Eastern District of Pennsylvania" Then
        ...
        'Call FileTranscriptSendEmail("inquiries@aquoco.co")
        Call pfSendWordDocAsEmail("TranscriptsReady", "Transcripts Ready", sPDFFinalTranscript, sWordFinalTranscript, sWorkingCopyPath)
...
DoCmd.OpenQuery "ShippingOptionsQ", acViewNormal, acNormal 'pull up shipping query
...
sNewSQL = "SELECT " & Chr(34) & sMailClass & Chr(34) & " as MailClass, " & Chr(34) & sPackageType & Chr(34) & _
    ...
    Chr(34) & "600 University St" & Chr(34) & " AS ToAddress1, " & Chr(34) & "One Union Square" & Chr(34) & " AS ToAddress2, " & Chr(34) & "Seattle" & Chr(34) _
    & " AS ToCity, " & Chr(34) & "WA" & Chr(34) & " AS ToState, " & _
...
oExcelSheet.Cells(2, 27).Value = "Seattle"
oExcelSheet.Cells(2, 28).Value = "WA"
