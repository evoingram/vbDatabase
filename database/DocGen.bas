...
If sMerge = "Case" Then
    ...
    sQueryName = "TR-Court-Union-AppAddr"
...
'DoCmd.OutputTo ObjectType:=acOutputQuery, ObjectName:="TR-Court-Union-AppAddr", OutputFormat:=acFormatXLS, Outputfile:=sCDLExcelExport, AutoStart:=False 'query info for label


sCDLExcelExport = "I:\" & sCourtDatesID & "\WorkingFiles\" & sCourtDatesID & "-CaseInfo.xls"
DoCmd.TransferSpreadsheet TransferType:=acExport, TableName:="TR-Court-Union-AppAddr", FileName:=sCDLExcelExport
